...
| R1 call telemetry | GO (branch, not installed) | `docs/phase-r/r1-closeout.json` | silent JSONL; compact contexts-with-spans + context.repoHash; live daemon untouched |
