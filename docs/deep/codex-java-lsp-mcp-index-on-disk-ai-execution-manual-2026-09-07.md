...
- **门**：deepEqual；T0。
- **拆分（2026-09-07）**：`P1-T3.a` `JavaIndexClientApi` + `JavaIndexClient` / router / context 类型；`P1-T3.b` `SqlJavaIndexClient` 点查 RPC。
...
- **拆分（2026-09-08 G3 loc）**：`P3-G3.a`–`P3-G3.j` 删 hibernate/recycle API、死文件、worker validators、快照 manifest、heap searchEntities；RouterJavaIndex/facts/view 迁到 agent-router；cold/incremental builder 迁到 `src/index-builder`。
