...
import type { JavaIndexClientApi, JavaIndexOpenOptions, JavaIndexRequestOptions } from "../java-index/java-index-client-api.js";
...
import { ENTITY_SEARCH_DEFAULT_LIMIT, type EntityHit } from "../java-index/entity-search.js";
import type {
  AnchorFacts,
  ContextGraphResult,
  GraphDigest,
  ...
  StaticEdgeKind
} from "../java-index/index-types.js";
import {
...
import {
  ...
  type JavaIndexView
} from "../java-index/java-index-view.js";
import {
  anchorToSourceFacts,
  bundleToSourceFacts,
  fallbackSourceFacts,
...
} from "../java-index/router-java-index-cold.js";
